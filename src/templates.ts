...
import conditionAlwaysSh from "./templates/condition-always.sh" with { type: "text" };
...
import hookMdMd from "./templates/hook-md.md" with { type: "text" };
import hookShSh from "./templates/hook-sh.sh" with { type: "text" };
...
export const BUNDLED: Record<string, string> = {
  ...
  "hook-md.md": hookMdMd,
  "hook-sh.sh": hookShSh,
  "condition-always.sh": conditionAlwaysSh,
};
