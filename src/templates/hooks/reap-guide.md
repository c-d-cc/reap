...
If `.reap/life/.session-init.log` exists, read it and show the contents to the user as a formatted status summary. This file is auto-generated by the SessionStart hook on every session start.
