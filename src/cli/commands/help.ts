...
const TOPICS_LIST = "workflow, lifecycle, genome, backlog, milestone, sequence, agents, hooks, config, evolve, regression, minor-fix, compression, merge, collaboration, maturity, memory, vision";
