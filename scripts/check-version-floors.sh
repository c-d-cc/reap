...
#
# Why this exists (gen-085): REAP holds a number that names a release on npm and
# is spent telling users to upgrade.
#
...
#
# The floor is currently satisfied, which is the point: the check has to exist
