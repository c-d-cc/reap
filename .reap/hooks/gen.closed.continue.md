...
남았는지 보는 곳 — 사람이 이번에 맡긴 목록, `.reap/life/handoff.md`의 열린 절, `.reap/life/backlog/`의 열린 항목, focus milestone의 `tasks/`.
...
멈추기로 했으면 그때 인계를 판단한다 — **다음 세션이 모르면 곤란한 것**이 있을 때만 `life/handoff.md`에 내 절을 남긴다. 없으면 쓰지 않는다.
