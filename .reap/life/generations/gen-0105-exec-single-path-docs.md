...
- README en·ko Install: `npm i -g @c-d-cc/reap` + `reap setup` 두 줄. "Coming from v0.17" 재작성. RELEASE_NOTES·site/release-notes-content: Changed[0]·Coming·Good to know
- 사이트 `ko.ts` 바꾼 자리(ms-022 검수 중인 파일): hero installStep1·installNote(783·785) · intro whatBuilds(815) · v018change 표 한 행(891) · quickStart 설치 4문구(932~936) · skill 표 migrate when(1799) · migration intro·updateCode·handoffDesc(1992~1995) · releaseNotes changed[0]·comingDesc·goodToKnow[0](2053·2069·2072). HeroPage.tsx 설치 코드 블록
