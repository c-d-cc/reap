...
- `claude --plugin-dir <worktree>/plugin -p "..."` 비대화 1회로 통과: 세션 시작 시 주입된 상태 줄(응답 언어·현재 milestone·열린 flux·기억·구조·안내문)을 원문 그대로 출력했고, `/reap:`로 시작하는 skill 10종(carve-milestone·cleanup·complete·evolve·init·interview·flux·migrate·orchestrate·report-issue)을 정확히 열거했다 — 2회 한도 중 1회만 사용
