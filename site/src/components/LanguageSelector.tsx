...
export function LanguageSelector() {
  ...
  // A single locale has nothing to switch to. Hidden rather than disabled,
  // so a reviewer adding `en` back finds the selector by removing this line
  // rather than by hunting for a disabled control.
  const hasChoice = LOCALES.length > 1;
