/**
 * Which of the available translations a browser's language preferences ask for.
 *
 ...
 * `DEFAULT_LOCALE` because that is the address it owns. Should they be sent to
 * their own language once?
 *
 * Keeping the two apart is the whole point. When `navigator.language` decided
 * what to render, every language shared one URL, a crawler could index only
 ...
 *
 * Tags are BCP-47: `ko`, `ko-KR`. Matching is on the primary subtag.
 */
