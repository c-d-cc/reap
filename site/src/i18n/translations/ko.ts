...
- [크기 안내선] 주입 합계 19.0KB > 16.0KB`,
  ...
  skills: {
    ...
    table: [
      ...
      ["handoff", "세션을 끝낼 때", "다음 세션이 이어받을 것이 있으면 life/handoff.md에 내 절을 남기고, 없으면 쓰지 않는다. 이어받은 절은 지운다"],
    ...
    skillList: [
      ...
      },
      {
        ...
        what: "인계가 필요한지부터 판단한다. 다음 세션이 모르면 곤란한 것이 있을 때만 life/handoff.md에 내 절을 쓰고, 이번 세션이 이어받은 절은 지운다. 열린 세대가 있으면 무엇을 하던 중이었는지 적는다.",
        notCalled: "다음 세션이 몰라도 되는 것뿐이면 아무것도 쓰지 않는 것이 답이다 — 끝난 일은 기록과 커밋에 있고, 열린 milestone과 flux는 상태 줄이 이미 알린다.",
      },
      {
        name: "evolve",
