...
- A new `handoff` skill, and you can call it yourself. Ending a session without going through `complete` used to leave nothing behind; now `/reap:handoff` writes, replaces or clears your section — and its first step is deciding whether one is warranted at all
