...
export const zhCN: Translations = {
  ...
  cli: {
    ...
    runNote: "所有28个斜杠命令都使用此架构：.md文件是调用reap run <cmd>的1行wrapper，TS脚本向AI代理返回structured JSON指令。",
  ...
  commands: {
    ...
    generalCommands: [
      ...
      ["/reapdev.docsUpdate", "基于代码变更更新文档、README、i18n翻译。仅限开发使用。"],
      ["/reapdev.versionBump", "分析变更并进行版本升级（含artifact验证）。仅限开发使用。"],
    ],
