...
commit:  1a2b3c4`,
  ...
  // Self-Evolving Page
  selfEvolvingPage: {
    title: "Selbstentwickelnde Funktionen",
    breadcrumb: "Leitfaden",
    intro: "REAP ist kein statisches Framework. Die KI wählt automatisch Ziele aus Vision und Gedächtnis aus, der Mensch beurteilt die Fitness durch natürlichsprachliches Feedback, und die Pipeline passt ihren Kommunikationsstil basierend auf der Kontextklarheit an. Diese Funktionen arbeiten zusammen, um eine Entwicklungs-Pipeline zu schaffen, die sich wirklich mit Ihrem Projekt weiterentwickelt.",
    gapDrivenTitle: "Lückengesteuerte Zielauswahl",
    gapDrivenDesc: "Am Ende jeder Generation (adapt-Phase) analysiert die KI die Lücke zwischen der Vision des Projekts und seinem aktuellen Zustand, um das nächste Ziel vorzuschlagen. Dies ist der Kernmechanismus, der REAP selbstentwickelnd macht.",
    gapDrivenSteps: [
      "Unerledigte Ziele aus vision/goals.md lesen",
      "Querverweisen mit ausstehenden Backlog-Einträgen zur Prioritätssteigerung",
      "Nach Auswirkung sortieren — Ziele mit zugehörigen Backlog-Aufgaben erzielen höhere Werte",
      "Den Top-Kandidaten dem Menschen zur Genehmigung vorschlagen",
    ],
    gapDrivenNote: "Im Cruise-Modus erfolgt die Zielauswahl automatisch zwischen Generationen ohne menschliches Eingreifen.",
    fitnessTitle: "Menschen beurteilen Fitness",
    fitnessDesc: "Es gibt keine quantitativen Metriken. Das natürlichsprachliche Feedback des Menschen während der Fitness-Phase ist das einzige Fitness-Signal. Der KI ist es ausdrücklich verboten, ihren eigenen Erfolg zu bewerten — nur Selbsteinschätzung (Metakognition) ist erlaubt.",
    fitnessNote: "Dies stellt sicher, dass sich das Projekt in die Richtung entwickelt, die der Mensch schätzt, nicht in die Richtung, die die KI optimieren kann.",
    clarityTitle: "Klarheitsgesteuerte Interaktion",
    clarityDesc: "Die KI bewertet dynamisch, wie gut der aktuelle Kontext definiert ist, und passt ihre Kommunikationstiefe entsprechend an. Die Klarheit wird zu Beginn jeder Generation während der Lernphase bewertet.",
    clarityHeaders: ["Klarheit", "Signale", "KI-Verhalten"],
    clarityRows: [
      ["High", "Klares Ziel, definierte Aufgaben, etablierte Muster", "Mit minimalen Fragen ausführen. Ergebnisse berichten."],
      ["Medium", "Richtung vorhanden, Details unklar", "2-3 Optionen mit Abwägungen präsentieren. Menschen wählen lassen."],
      ["Low", "Mehrdeutiges Ziel, widersprüchliche Einschränkungen", "Aktiver Dialog mit Beispielen zum Aufbau gemeinsamen Verständnisses."],
    ],
    cruiseTitle: "Cruise-Modus",
    cruiseDesc: "N Generationen zur autonomen Ausführung vorab genehmigen. Die KI wählt Ziele aus Vision-Lücken und Backlog-Aufgaben, führt den vollständigen Lebenszyklus aus und bewertet jede Generation selbst (bewertet nicht selbst).",
    cruiseActivation: "Aktivierung:",
    cruiseActivationDesc: "Setzt cruiseCount: 1/5 in config.yml. Der Zähler wird nach jeder abgeschlossenen Generation erhöht.",
    cruiseGoalSelection: "Zielauswahl:",
    cruiseGoalSelectionDesc: "Während der adapt-Phase analysiert die KI Lücken zwischen vision/goals.md und dem aktuellen Zustand und wählt dann das wertvollste nächste Ziel.",
    cruiseFitness: "Fitness:",
    cruiseFitnessDesc: "Im Cruise-Modus verwendet die Fitness-Phase Selbsteinschätzung (Metakognition) anstatt auf menschliches Feedback zu warten. Der KI ist es ausdrücklich verboten, ihren eigenen Erfolg zu bewerten.",
    cruisePause: "Pausenbedingungen:",
    ...
    memoryRows: [
      ...
      ["midterm", "Laufende Tracks", "\"Ist das ein unabgeschlossener großer Track?\"", "Wird bei Abschluss gelöscht, nachdem die Lektionen übernommen wurden"],
      ["longterm", "Design-Lektionen", "\"Verhindert das denselben Fehler in der nächsten Generation?\"", "Einträge, die bereits im Genome stehen, werden entfernt"],
    ],
    memoryRulesTitle: "Regeln:",
    memoryRules: [
    ...
    visionEvolutionTitle: "Vision & Lückengesteuerte Evolution",
    visionEvolutionDesc: "Vision ist der primäre Treiber jeder Generation. Die Datei .reap/vision/goals.md definiert Nordstern-Ziele für das Projekt. Während der adapt-Phase führt die KI eine Lückenanalyse durch: Sie vergleicht Vision-Ziele mit dem aktuellen Zustand der Codebasis.",
    visionSteps: [
      { title: "1. Zieldefinition", desc: "Der Mensch schreibt übergeordnete Ziele in goals.md. Jedes Ziel ist ein Markdown-Checkbox-Element. Ziele können für Unterziele verschachtelt werden." },
      { title: "2. Lückenanalyse (adapt-Phase)", desc: "Die KI vergleicht unerledigte Ziele mit der aktuellen Codebasis, Umgebung und Generationshistorie. Sie identifiziert die wertvollste Lücke und schlägt sie als Ziel der nächsten Generation vor." },
      { title: "3. Automatische Markierung", desc: "Wenn eine Generation ein Vision-Ziel erreicht, markiert die KI das entsprechende Kontrollkästchen in goals.md während der adapt-Phase. Dies bietet eine dauerhafte Ansicht des Projektfortschritts." },
      { title: "4. Kontinuierlicher Zyklus", desc: "Vision entwickelt sich ebenfalls weiter. Der Mensch aktualisiert Ziele, wenn sich die Projektrichtung ändert. Die KI referenziert sowohl abgeschlossene als auch verbleibende Ziele, um die Flugbahn beizubehalten." },
    ],
  },
  ...
  visionPage: {
    title: "Vision",
    breadcrumb: "Leitfaden",
    intro: "Vision ist die Schicht, die die Richtung bestimmt. Der Mensch definiert, wohin das Projekt geht — setzt Ziele, Meilensteine und Prioritäten. Die KI referenziert die Vision während der adapt-Phase, um Lücken zu analysieren und das nächste Ziel vorzuschlagen, aber der Mensch besitzt die Vision.",
    structureTitle: "Struktur",
    goalsTitle: "Ziele",
    goalsDesc: "goals.md enthält die langfristigen Ziele des Projekts als Checkliste. Während der adapt-Phase analysiert die KI Lücken zwischen Vision und aktuellem Zustand, um das Ziel der nächsten Generation vorzuschlagen. Abgeschlossene Ziele werden automatisch abgehakt.",
    memoryTitle: "Gedächtnis",
    memoryDesc: "Gedächtnis ist ein freiformiges Aufzeichnungssystem, in dem die KI Kontext über Sitzungen und Generationen hinweg persistiert. Im Gegensatz zum Genome (mit Modifikationsbeschränkungen) oder Lineage (wird komprimiert) ist das Gedächtnis immer zugänglich und frei beschreibbar.",
    memoryHeaders: ["Ebene", "Rolle", "Entscheidungsregel"],
    memoryRows: [
      ["Shortterm", "Session-Übergabe — Kontext für die nächste Sitzung", "\"Wird das gerade jetzt gebraucht?\""],
      ["Midterm", "Laufende Tracks — generationsübergreifende Arbeit", "\"Ist das ein unabgeschlossener großer Track?\""],
      ["Longterm", "Design-Lektionen — später erneut lesenswert", "\"Verhindert das einen wiederholten Fehler?\""],
    ],
    whenToUpdateTitle: "Wann aktualisieren",
    whenToUpdateItems: [
      { label: "Reflect-Phase", desc: "natürlicher Zeitpunkt zum Aktualisieren des Gedächtnisses (shortterm ist bei jeder Generation obligatorisch)" },
      { label: "Jederzeit", desc: "Gedächtnis kann in jeder Phase aktualisiert werden, wenn nützlicher Kontext entsteht" },
      { label: "Shortterm-Bereinigung", desc: "erledigte Einträge entfernen" },
    ],
    whatNotTitle: "Was NICHT ins Gedächtnis schreiben",
    whatNotItems: [
      "Code-Änderungsdetails — gehören in Environment",
      "Testanzahlen oder Build-Status — gehören in Artefakte",
      "Bereits im Genome enthaltene Prinzipien — keine Duplizierung",
    ],
    gapDrivenTitle: "Lückengesteuerte Evolution",
    gapDrivenDesc: "Während der adapt-Phase der Completion führt die KI folgendes aus:",
    gapDrivenSteps: [
      "goals.md lesen und Backlog scannen",
      "Unerledigte Ziele und ausstehende Aufgaben identifizieren",
      "Mit dem aktuellen Projektzustand querverweisen",
      "Das Ziel der nächsten Generation basierend auf der wirkungsvollsten Lücke vorschlagen",
    ],
  },

  // Migration Guide Page
  migrationGuidePage: {
    title: "Migrationsleitfaden (v0.15 → v0.16)",
    breadcrumb: "Sonstiges",
    intro: "REAP v0.16 ist eine vollständige Neuentwicklung basierend auf der Architektur der selbstentwickelnden Pipeline. Der Lebenszyklus, die Genome-Struktur, die Konfiguration und das Vision-System wurden alle neu gestaltet. Ein geführtes Migrationstool übernimmt den Übergang automatisch.",
    whyMigrateTitle: "Warum migrieren?",
    whyMigrateItems: [
      "Lebenszyklus neu gestaltet: learning ersetzt objective als erste Phase",
      "Genome in 3 fokussierte Dateien umstrukturiert (application.md, evolution.md, invariants.md)",
      "Vision-Schicht mit 3-Ebenen-Gedächtnis für generationsübergreifende Kontextpersistenz",
      "Merge-Lebenszyklus mit Genome-first-Abstimmung",
      "Dateibasierte Hooks ersetzen Inline-Hook-Konfiguration",
    ],
    stepsTitle: "Migrationsschritte",
    step1: "v0.16 global installieren. Dies stellt automatisch v0.16-Skills bereit und entfernt alte v0.15-Projektebene-Skills.",
    step2: "Öffnen Sie Claude Code in Ihrem Projekt und führen Sie den Migrationsbefehl aus.",
    step3: "Folgen Sie der 5-Phasen-geführten Migration:",
    step3Headers: ["Phase", "Was passiert", "Ihre Rolle"],
    step3Rows: [
      ["confirm", "Zeigt an, was sich ändert, erstellt Backup unter .reap/v15/", "Überprüfen und bestätigen"],
      ["execute", "Verzeichnisse umstrukturieren, config/hooks/lineage/backlog migrieren", "Automatisch"],
      ["genome-convert", "KI rekonstruiert Genome aus v0.15-Dateien in neue 3-Datei-Struktur", "KI-Arbeit überprüfen"],
      ["vision", "vision/goals.md und Gedächtnis-Ebenendateien einrichten", "Projektrichtung angeben"],
      ["complete", "Zusammenfassung der Migrationsergebnisse", "Verifizieren"],
    ],
    step4: "Überprüfen Sie, ob die Migration erfolgreich war.",
    whatChangesTitle: "Was sich ändert",
    whatChangesHeaders: ["Bereich", "v0.15", "v0.16"],
    whatChangesRows: [
      ["Lifecycle", "objective → planning → impl → validation → completion (5 Phasen)", "learning → planning → impl → validation → completion (4 Phasen)"],
      ["Genome", "Mehrere Dateien, flache Struktur", "3 Dateien: application.md + evolution.md + invariants.md"],
      ["Config", "JSON-basierte Konfiguration", "YAML-basierte config.yml mit cruiseCount, strictEdit, strictMerge, autoSubagent"],
      ["Vision", "Kein Vision-System", "vision/goals.md + 3-Ebenen-Gedächtnis"],
      ["Hooks", "Inline-Konfiguration", "Dateibasiert: .reap/hooks/{event}.{name}.{md|sh}"],
      ["Environment", "Einzelne Wissensdatei", "2-Ebenen: summary.md (immer geladen) + domain/ (bei Bedarf)"],
    ],
    interruptedTitle: "Unterbrochene Migration",
    interruptedDesc: "Wenn die Migration unterbrochen wird (API-Fehler, Sitzungsabbruch usw.), wird der Fortschritt in .reap/migration-state.yml gespeichert. Diese Datei verfolgt, welche Phasen abgeschlossen wurden.",
    interruptedResume: "Zum Fortsetzen:",
    interruptedResumeDesc: "Führen Sie /reap.update erneut aus. Es überspringt abgeschlossene Phasen und fährt dort fort, wo es aufgehört hat.",
    interruptedRestart: "Zum Neustart:",
    interruptedRestartDesc: "Löschen Sie .reap/migration-state.yml und führen Sie /reap.update erneut aus.",
    backupTitle: "Backup",
    backupDesc: "Alle v0.15-Dateien werden während der confirm-Phase unter .reap/v15/ aufbewahrt. Dies ist ein vollständiger Snapshot Ihres Vor-Migrations-Zustands.",
    backupItems: [
      "Das Backup wird erstellt, bevor destruktive Änderungen auftreten",
      "Nach Überprüfung der Migration (/reap.status, /reap.evolve) können Sie .reap/v15/ sicher löschen",
      "Behalten Sie das Backup mindestens eine vollständige Generation lang, um zu bestätigen, dass alles funktioniert",
    ],
    deprecatedTitle: "Veraltete Befehle",
    deprecatedDesc: "Mehrere v0.15-Slash-Befehle wurden in v0.16 umbenannt oder zusammengefasst.",
    deprecatedHeaders: ["v0.15-Befehl", "v0.16-Ersatz", "Hinweise"],
    deprecatedRows: [
      ["/reap.sync", "/reap.knowledge", "Verwaltet Genome, Environment und Kontextwissen"],
      ["/reap.refreshKnowledge", "/reap.knowledge reload", "Alle Wissensdaten von der Festplatte neu laden"],
      ["/reap.objective", "/reap.run", "Phasenweise Befehle durch reap run <stage> ersetzt"],
      ["/reap.complete", "/reap.run", "Phasenweise Befehle durch reap run <stage> ersetzt"],
    ],
    deprecatedNote: "Alte v0.15-Projektebene-Skill-Dateien werden während npm install automatisch entfernt. Falls noch welche in .claude/commands/ vorhanden sind, können sie sicher gelöscht werden.",
  },
  ...
  releaseNotes: {
    ...
    versions: [
      {
        version: "0.17.7",
        notes: "**Die Dokumentationsseite lieferte für jede Seite dieselbe leere Hülle aus.** `reap.cc/docs/*` antwortete auf jede Adresse mit HTTP 404, und zwar seit dem Start der Seite — eine Single-Page-App auf GitHub Pages, also bekam jede URL dieselbe 939 Byte große Hülle, die Hülle startete, der Router zeichnete die richtige Seite, und für einen Menschen sah die Seite perfekt aus. Suchmaschinen sahen einen 404 und indexierten nichts außer der Wurzel. **Jede Seite wird jetzt zur Build-Zeit gerendert**: 23 Routen in fünf Sprachen, 115 Dateien, jede mit eigenem Inhalt, `<title>`, `<meta description>`, kanonischer URL und `hreflang`-Alternativen, dazu eine `sitemap.xml` und eine `robots.txt`, die es nicht gab. Die kleinste Seite wuchs von 939 Byte auf 15 kB. **Sprachen haben eigene Adressen.** Englisch behält die bisherigen — `reap.cc/docs/quick-start` — die anderen vier bekommen ein Präfix: `/ko/docs/quick-start`, `/ja/...`, `/de/...`, `/zh-CN/...`. Vorher teilten sich die fünf eine URL und der Browser entschied, sodass ein Crawler nur eine davon indexieren konnte und ein geteilter Link jedem eine andere Sprache zeigte. Wer auf `/` landet, wird weiterhin einmal pro Tab in die eigene Sprache geschickt; jede andere Adresse bleibt genau so, wie sie angefordert wurde. **Der stillgelegte Daemon ist aus der Dokumentation verschwunden, nicht nur aus dem Code** — darunter eine Migrationsnotiz, die `npm i -g @c-d-cc/reap-daemon`, ein veraltetes Paket, in den Kontext jeder Sitzung einspeiste, in Projekten, die ihn nie aktiviert hatten. **`/docs/daemon` heißt jetzt `/docs/code-intelligence`; ein Lesezeichen auf die alte Adresse funktioniert nicht mehr.** Am CLI hat sich nichts geändert.",
      },
      {
        version: "0.17.6",
        notes: "**REAP liefert einen Code-Index mit.** Nichts zu installieren, kein Port, kein Hintergrundprozess — `reap index status`, `reap index impact <file>`, `reap index search <query>`, `reap index callers/callees <symbolId>`. Fünfzehn Sprachen, kein nativer Build. **Der Blast Radius lieferte in jedem gewöhnlichen TypeScript-Projekt null**, und zwar fünf Monate lang: der Resolver ordnete einen `./x.js`-Specifier nie der `x.ts` zu, aus der er entsteht. 130 Tests bestanden und CI blieb durchgehend grün, weil jede Prüfung fragte, ob indiziert wurde, und keine, ob das Ergebnis Sinn ergibt. **Deshalb meldet `reap index status` nun die Import-Auflösungsrate**, und das Release-Gate verlangt, dass eine bekannte Beziehung gefunden wird, statt einer Symbolzahl über null. **Indiziert wird pro Commit** — ein vollständiger Index von REAP dauert ~0,3 s, Abfragen aktualisieren sich selbst, sobald HEAD sich bewegt, und nicht committete Arbeit wird bewusst nicht indiziert. Der Index liegt in `.reap/.index/` und ist gitignored. **`reap uninstall`** entfernt, was npm nicht kann — Slash-Befehle, Agentendefinitionen, `~/.reap/` und die SessionStart-Hook-Einträge, die `npm uninstall -g` zurücklässt, weil Uninstall-Hooks unter npm 10 und 12 nicht ausgeführt werden. **Das ausgelieferte Genom weist Agenten nun an, `environment/source-map.md` zu lesen, bevor sie Code ändern**, und `reap init` legt diese Datei für Greenfield-Projekte an — was es zuvor nicht tat, sodass die bloße Übernahme der Regel den Agenten jedes neuen Projekts auf eine nicht existierende Datei verwiesen hätte. `summary.md` wird in jeder Sitzung geladen, source-map nicht; genau so bleibt ein Strukturdokument ungeöffnet, während der darin beschriebene Code geändert wird. Bestehende Projekte besitzen ihre eigene `genome/evolution.md`, deshalb erreicht sie die Regel über den Migrationshinweis zu v0.17.6, der auch sagt, was zu tun ist, wenn die Datei selbst fehlt. Dieselbe Notiz korrigiert auch die andere Hälfte dieser Datei: Sie wies die Reflect-Phase an, die Strukturbeschreibung in `summary.md` zu pflegen — die neue Regel hätte sonst auf eine Datei gezeigt, die niemand zu schreiben angewiesen ist. **Eine Installation von REAP in ein Projekt verändert Ihre globale Installation nicht mehr.** Das Auto-Update fragte `reap --version` nach der \"installierten\" Version — das ist die Binärdatei, die im PATH zuerst gefunden wird, nicht das Paket, zu dem der Code gehört — und aktualisierte anschließend bedingungslos die globale Installation. Wer REAP in ein Projekt installierte, während global eine ältere Version lag, dessen postinstall aktualisierte die globale Installation, von der nie die Rede war. REAP liest nun die eigene `package.json`, und nur eine globale Installation aktualisiert sich selbst: eine projektlokale Kopie, ein `npx`-Lauf und ein Quellcode-Checkout bleiben unangetastet. **Und `autoUpdate: false` schaltet die Selbstaktualisierung jetzt tatsächlich ab.** Der Schalter steht seit v0.16 in `.reap/config.yml` — von `reap init` angelegt, von `reap update` bewahrt, von `reap config` angezeigt, im `/reap.config`-Skill als \"auto-update enabled\" dokumentiert, von `reap fix` typgeprüft — und von nichts gelesen. Wer ihn auf `false` setzte, sah `false` und bekam die globale Installation trotzdem ersetzt. Er stoppt jetzt die Installation, und nur sie: die Warnung zur harten Untergrenze — dass die eigene Kopie zu alt ist, als dass REAP sie automatisch reparieren könnte — erreicht Sie weiterhin, denn wer die automatische Reparatur abgelehnt hat, muss davon am ehesten erfahren. `reap update` und ein selbst getipptes `npm install -g` bleiben unberührt; der Schalter regelt allein die eine Installation, die REAP von sich aus durchführt. Lässt sich die Konfiguration gar nicht lesen, bleibt die Selbstaktualisierung aktiv: npm führt postinstall im Paketverzeichnis aus, wo es keine Projektkonfiguration gibt — \"nicht feststellbar\" als \"aus\" zu lesen hätte sie für alle abgeschaltet statt für die, die darum gebeten haben. Der Geltungsbereich sei deutlich gesagt: Der Schalter regelt den wiederkehrenden Pfad — jeden Sitzungsstart — und nicht das postinstall eines gerade selbst getippten `npm install`, das dort läuft, wo Ihre Projektkonfiguration nicht liegt.",
      },
      {
        version: "0.17.5",
        notes: "**`reap run push` meldet den echten git-Fehler**, und **`reap help` listet `/reap.run` und `/reap.report`**. **REAP installiert seine eigene Integration beim ersten Aufruf** — npm 12 blockiert Install-Skripte bei globalen Installationen, wodurch Slash-Befehle, Agent-Definitionen und der Session-Hook ohne jede Fehlermeldung ungesetzt blieben.",
      },
      {
        version: "0.17.4",
      ...
      {
        version: "0.17.1",
        notes: "**Migration Instruction Layer** — `reap update` erkennt die Lücke zwischen `lastMigratedVersion` eines Projekts und der installierten REAP-Version und fügt die passenden versionsspezifischen Migrationsnotizen in den SessionStart-Kontext des Agents ein. Agents erhalten konkrete Anweisungen zur Reorganisation bestehender Artefakte nach einem Upgrade; nach der Anwendung `reap update --mark-migrated` ausführen. **Memory-Struktur** — Vision-Memory nutzt jetzt inhaltstypbasierte Tiers mit verpflichtender Pruning-Richtlinie in der Reflect-Phase.",
      },
      {
        version: "0.17.0",
        notes: "**Evaluator Agent** — Fitness-Phase-Integration abgeschlossen: Evaluator läuft in Fitness-Phase, Prior Concerns im Prompt sichtbar, bei high-severity Cruise-Modus automatisch unterbrochen.",
      },
      {
        version: "0.16.6",
      ...
      {
        version: "0.16.5",
        notes: "**OpenCode-Adapter** — vollständige Multi-Client-Unterstützung über `agentClient: opencode`. Verwaltet automatisch die `opencode.json`-Instructions, `.opencode/plugins/reap-plugin.ts`, AGENTS.md und die Slash-Befehle unter `~/.config/opencode/commands/`. **Early-Close-Lifecycle-Pfad** — leichtgewichtige Beendigung aus Implementation oder Validation (`reap run early-close`, `/reap.early-close`). Erhält den Teilfortschritt, führt ein verschlanktes Reflect aus und überträgt unvollständige Tasks automatisch als Backlog-Eintrag in die nächste Generation. Äußert ein Nutzer Abbruch- oder Scope-Reduktionsabsicht, bietet der Agent explizit die drei Optionen abort / early-close / continue an.",
      },
      {
        version: "0.16.4",
