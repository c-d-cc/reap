...
reap daemon query    # Symbol-Abfrage ausführen`,
  ...
  selfEvolvingPage: {
    ...
    memoryHeaders: ["Ebene", "Lebensdauer", "Inhalt", "Aktualisierungsauslöser"],
    memoryRows: [
      ["longterm", "Projektlebensdauer", "Wiederkehrende Muster, Gründe für Architekturentscheidungen, Design-Lektionen", "Wenn Lektionen entstehen"],
      ["midterm", "Mehrere Generationen", "Laufender Aufgabenfluss, Multi-Gen-Pläne, vereinbarte Richtungen", "Wenn sich der Kontext ändert"],
      ["shortterm", "1-2 Sitzungen", "Sitzungsübergabe, unerledigte Diskussionen, Backlog-Snapshots", "Jede Generation (obligatorisch)"],
    ],
    memoryRulesTitle: "Regeln:",
    memoryRules: [
      "Jederzeit lesen und schreiben — keine Phasenbeschränkung, keine Erlaubnis nötig",
      "Inhalt und Zeitpunkt liegen im Ermessen der KI. Kein verpflichtendes Format",
      "Inhalte in der Ebene platzieren, die ihrer erwarteten Lebensdauer entspricht. Bei Relevanzänderung hoch-/herabstufen",
      "Übersichtlich halten — Aufzählungspunkte statt Absätze. Leere Dateien sind ein gültiger Zustand",
      "Gedächtnis wird mit dem Projekt git-committed und ist für jeden KI-Agenten zugänglich",
    ],
  ...
  visionPage: {
    ...
    memoryHeaders: ["Ebene", "Lebensdauer", "Zweck"],
    memoryRows: [
      ["Shortterm", "1-2 Sitzungen", "Generationszusammenfassung, nächste Sitzungsübergabe, unentschiedene Angelegenheiten"],
      ["Midterm", "Mehrere Generationen", "Großer Aufgabenfluss, Multi-Gen-Pläne, vereinbarte Richtungen"],
      ["Longterm", "Projektlebensdauer", "Design-Lektionen, Architekturentscheidungsbegründung, Übergangslektionen"],
    ],
