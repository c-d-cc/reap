export const en = {
  ...
  commands: {
    ...
    knowledgeTitle: "Knowledge Commands",
    knowledgeCommands: [
      ["/reap.knowledge", "Manage genome, environment, and context knowledge. No argument shows options. Subcommands: reload, genome, environment. (Replaces former /reap.sync)"],
      ["/reap.init", "Initialize REAP in a project. Auto-detects greenfield vs existing codebase. Options: [project-name] [--mode <greenfield|adoption>]"],
    ...
    generalTitle: "Info & Utility Commands",
    generalCommands: [
      ...
      ["/reap.update", "Run migration from v0.15 to v0.16. Multi-phase: confirm, execute, genome convert, vision, complete."],
    ],
