export const en = {
  ...
  cli: {
    ...
    runNote: "All 28 slash commands use this architecture: the .md file is a 1-line wrapper that calls reap run <cmd>, and the TS script returns structured JSON instructions for the AI agent.",
  ...
  commands: {
    ...
    generalCommands: [
      ...
      ["/reapdev.docsUpdate", "Update docs, README, and i18n translations based on code changes. Dev-only command."],
      ["/reapdev.versionBump", "Analyze changes and bump version with artifact validation. Dev-only command."],
    ],
