export const en = {
  ...
  cli: {
    ...
    updateGenomeTitle: "reap update-genome",
    updateGenomeDesc: "Update genome files from CLI (non-interactive).",
    updateGenomeNote: "Applies pending genome updates without requiring an AI agent session. Useful for CI/CD pipelines or batch operations.",
