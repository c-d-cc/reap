...
export const ko: Translations = {
  ...
  cli: {
    ...
    runNote: "28개 슬래시 커맨드 모두 이 아키텍처를 사용합니다: .md 파일이 reap run <cmd>를 호출하는 1줄 wrapper이고, TS 스크립트가 AI 에이전트에게 structured JSON 지시를 반환합니다.",
    ...
    destroyNote: "프로젝트에서 .reap/ 디렉토리와 모든 REAP 관련 파일을 완전히 제거합니다. 실행하려면 명시적 확인이 필요합니다.",
    helpTitle: "reap help",
